...
#line 51 "src\\FlexBisonFiles\\parser.y"
...
{
       0,   101,   101,   102,   105,   106,   107,   108,   109,   112,
     113,   114,   115,   116,   119,   120,   123,   124,   127,   128,
     129,   130,   131,   132,   133,   134,   138,   139,   142,   143,
     144
};
#endif
...
static const char *const yytname[] =
{
  ...
  "','", "'\\n'", "for", "next", "to", "read", "def", "identifier",
  "string", "constantInt", "constantFloat", "type", "'='", "'+'", "'-'",
  "'*'", "'/'", "'('", "')'", "$accept", "program", "statement", "line",
  "DefOp", "ReadOp", "expression", "list", "variable", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
     ...
     261,   262,   263,   264,   265,   266,   267,   268,   269,    61,
      43,    45,    42,    47,    40,    41
};
# endif
...
{
     -23,    28,   -23,    51,   -12,   -23,     3,   -23,   -23,     9,
     -12,   -12,    13,    24,   -12,    19,    38,    45,    49,    41,
      37,   -23,    24,    37,   -23,   -12,   -23,    55,   -23,   -23,
      37,     4,   -23,   -23,    -8,   -23,   -12,    46,    37,    37,
      37,    37,    37,   -23,    37,   -23,   -23,    52,   -18,   -18,
     -23,   -23,    27,   -23,    50,    32,    50,    62,    64,   -23,
     -23,   -23
};
...
{
       2,     0,     1,     0,     0,     8,    11,     3,     7,     0,
       0,     0,    28,    13,     0,     0,     0,    16,     0,     0,
       0,    12,    10,     0,     6,     0,     5,    14,    18,    19,
       0,     0,    20,     9,     0,    17,     0,     0,     0,     0,
       0,     0,     0,    29,     0,    15,    25,     0,    21,    22,
      23,    24,     0,    30,     0,     0,     0,     0,     0,    26,
       4,    27
};
...
{
     -23,   -23,    75,    18,    43,    56,   -22,    26,    -4
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,    56,     8,    18,    16,    31,    57,    32
};
...
{
      13,    34,    12,    44,    41,    42,    17,    19,    37,    14,
      22,    38,    39,    40,    41,    42,    47,    48,    49,    50,
      51,    17,    52,    15,    39,    40,    41,    42,     2,    43,
       4,    21,    19,     3,     4,    54,     5,    20,    23,     6,
      33,     9,    58,     6,    10,    11,    24,    39,    40,    41,
      42,    12,    25,    28,    29,    55,     4,    26,     5,    27,
       9,    30,    36,    10,    11,     6,    39,    40,    41,    42,
      60,    46,    39,    40,    41,    42,     7,    53,    61,    45,
       0,    35,    59
};

static const yytype_int8 yycheck[] =
{
       4,    23,    14,    11,    22,    23,    10,    11,    30,     6,
      14,     7,    20,    21,    22,    23,    38,    39,    40,    41,
      42,    25,    44,    14,    20,    21,    22,    23,     0,    25,
       6,    13,    36,     5,     6,     8,     8,    24,    19,    15,
      22,     9,    10,    15,    12,    13,     8,    20,    21,    22,
      23,    14,     7,    16,    17,     5,     6,     8,     8,    18,
       9,    24,     7,    12,    13,    15,    20,    21,    22,    23,
       8,    25,    20,    21,    22,    23,     1,    25,    14,    36,
      -1,    25,    56
};
...
{
       0,    27,     0,     5,     6,     8,    15,    28,    29,     9,
      12,    13,    14,    34,     6,    14,    31,    34,    30,    34,
      24,    29,    34,    19,     8,     7,     8,    18,    16,    17,
      24,    32,    34,    29,    32,    31,     7,    32,     7,    20,
      21,    22,    23,    25,    11,    30,    25,    32,    32,    32,
      32,    32,    32,    25,     8,     5,    28,    33,    10,    33,
       8,    14
};
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, yyscan_t scanner, CParseTree* pParseTree)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (yylocationp);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, yyscan_t scanner, CParseTree* pParseTree)
{
  YYFPRINTF (yyo, "%s %s (",
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yytype, yyvaluep, yylocationp, scanner, pParseTree);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp, int yyrule, yyscan_t scanner, CParseTree* pParseTree)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, yyscan_t scanner, CParseTree* pParseTree)
{
  YYUSE (yyvaluep);
  YYUSE (yylocationp);
  YYUSE (scanner);
...
int
yyparse (yyscan_t scanner, CParseTree* pParseTree)
{
...
#line 61 "src\\FlexBisonFiles\\parser.y"
{
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3:
#line 102 "src\\FlexBisonFiles\\parser.y"
    { (yyvsp[0].a)->Action(); }
...
#line 105 "src\\FlexBisonFiles\\parser.y"
    { (yyval.a) = new FORnode((yyvsp[-7].str), (yyvsp[-5].a), (yyvsp[-3].a), (yyvsp[-1].a)); }
#line 1428 "parser.cpp"
    break;

  case 5:
#line 106 "src\\FlexBisonFiles\\parser.y"
    { (yyval.a) = (yyvsp[-1].a); }
#line 1434 "parser.cpp"
    break;

  case 6:
#line 107 "src\\FlexBisonFiles\\parser.y"
    {(yyval.a) = (yyvsp[-1].a); }
...
#line 114 "src\\FlexBisonFiles\\parser.y"
    { (yyval.a) = new LINEnode((yyvsp[0].str), NULL, NULL); }
